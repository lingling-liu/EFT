...
for(MODIS in c('MODIS_b2_w3', 'MODIS_b2_w5','MODIS_b2_w7', 'MODIS_b4_w3','MODIS_b4_w5','MODIS_b4_w7')){
  for(Landsat in c('Landsat_b2_w3', 'Landsat_b2_w5','Landsat_b2_w7', 'Landsat_b4_w3','Landsat_b4_w5','Landsat_b4_w7')){
    print(MODIS)
    print(Landsat)
    
    # MODIS <- "MODIS_b2_w3"
    # Landsat <- "Landsat_b2_w3"
...
ggsave("C:\\EFT\\EFD\\percentiles\\EFD_gee\\EFD_sensors_comparsion.jpg", p3,width = 40, height = 40, units = "cm")
