...
result1 = cor_1
#result1_p = cor_2$
#(cor_2,"C:\\Costa_Rica\\EFT\\EFAs\\MODIS\\MODIS_EFAs_correlations_mean.csv")
...
#write.csv(t(corr_res),"C:\\Costa_Rica\\EFT\\EFAs\\MODIS\\MODIS_EFAs_correlations_linear_circular.csv")
#write.csv(t(p_res),"C:\\Costa_Rica\\EFT\\EFAs\\MODIS\\MODIS_EFAs_correlations_p_value_linear_circular.csv")
...
write.csv(result_all,"C:\\Costa_Rica\\EFT\\EFAs\\MODIS\\MODIS_EFAs_correlations_all.csv",append = True)
