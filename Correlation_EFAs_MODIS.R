...
#**************************Linear variable****************************
#mean
str_name = "C:\\Costa_Rica\\EFT\\EFAs\\MODIS\\MODIS_mean_2014_2019.tif"
...
#SD
str_name = "C:\\Costa_Rica\\EFT\\EFAs\\MODIS\\MODIS_SD_2014_2019.tif"
imported_raster=raster(str_name)
print(imported_raster)
...
#CV
str_name = "C:\\Costa_Rica\\EFT\\EFAs\\MODIS\\MODIS_CV_2014_2019.tif"
imported_raster=raster(str_name)
print(imported_raster)
...
#Min_VI
str_name = "C:\\Costa_Rica\\EFT\\EFAs\\MODIS\\MODIS_Min_VI_2014_2019.tif"
imported_raster=raster(str_name)
print(imported_raster)
...
#Max_VI_
str_name = "C:\\Costa_Rica\\EFT\\EFAs\\MODIS\\MODIS_Max_VI_2014_2019.tif"
imported_raster=raster(str_name)
print(imported_raster)
...
#Gslope Greening_VI
str_name = "C:\\Costa_Rica\\EFT\\EFAs\\MODIS\\MODIS_Greening_VI_2014_2019.tif"
imported_raster=raster(str_name)
print(imported_raster)
...
#Bslope Browning_VI
str_name = "C:\\Costa_Rica\\EFT\\EFAs\\MODIS\\MODIS_Browning_VI_2014_2019.tif"
imported_raster=raster(str_name)
print(imported_raster)
...
#GreenTime
str_name = "C:\\Costa_Rica\\EFT\\EFAs\\MODIS\\MODIS_GreenTime_2014_2019.tif"
imported_raster=raster(str_name)
print(imported_raster)
...
#BrownTime
str_name = "C:\\Costa_Rica\\EFT\\EFAs\\MODIS\\MODIS_BrownTime_2014_2019.tif"
imported_raster=raster(str_name)
print(imported_raster)
...
result <- cor.circular(y_cir2,y_cir3, test = TRUE)
print(result)
result <- cor.circular(y_cir2,y_cir4, test = TRUE)
print(result)
result <- cor.circular(y_cir3,y_cir4, test = TRUE)
print(result)
