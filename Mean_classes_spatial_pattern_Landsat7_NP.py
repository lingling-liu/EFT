...
outname = r'C:\EFT\Landsat7_mean_2001_2017_3classes_NP.tif'
...
plt.title('Landsat7_NP_mean_3classes')
plt.axis('off')
...
outname = r'C:\EFT\Landsat7_mean_2001_2017_4classes_NP.tif'
gdal_array.SaveArray(output, outname, "gtiff", prototype=dataset)
...
im = pre_lidar_chm_class_ma.plot.imshow(cmap=cmap,norm=norm)
plt.title('Landsat7_NP_mean_4classes')
plt.axis('off')
...
outname = r'C:\EFT\Landsat7_mean_2001_2017_5classes_NP.tif'
gdal_array.SaveArray(output, outname, "gtiff", prototype=dataset)
...
im = pre_lidar_chm_class_ma.plot.imshow(cmap=cmap,norm=norm)
plt.title('Landsat7_NP_mean_5classes')
plt.axis('off')
...
outname = r'C:\EFT\Landsat7_mean_2001_2017_6classes_NP.tif'
gdal_array.SaveArray(output, outname, "gtiff", prototype=dataset)
...
im = pre_lidar_chm_class_ma.plot.imshow(cmap=cmap,norm=norm)
plt.title('Landsat7_NP_mean_6classes')
plt.axis('off')

#plt.show()
plt.savefig("Landsat7_NP_mean_spatial_patterns_different_classes.png")
