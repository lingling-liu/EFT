var point = /* color: #d63000 */ee.Geometry.Point([-84.1153564453125, 10.083754913473248]),
    ...
    costa_rica = ee.FeatureCollection("users/lliu6/NicoyaPeninsula_boundaries_lat_lon");
...
var Feno = browning_time.where(browning_time.lte(0.22), 1); //March April
Feno = Feno.where(browning_time.gt(0.22).and(browning_time.lte(0.42)),2); //May Jun
Feno = Feno.where(browning_time.gt(0.42), 3); //Aug Sep
...
Map.addLayer(TFEclas, vizParamsTFEclasArctic, 'TFE1-64');
    ...
    Export.image.toDrive({
      image: TFEclas,
      description: 'EFT_Landsat7_EVI_2001_2017_NP',
      region: costa_rica,
      maxPixels: 1e13,
      folder: GDriveOutputImgFolder,
      scale: scale
