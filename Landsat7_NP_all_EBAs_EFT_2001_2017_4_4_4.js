...
var Seasonality = Season.where(Season.lte(Season25), 10);
Seasonality = Seasonality.where(Season.gt(Season25).and(Season.lte(Season50)),20); 
Seasonality = Seasonality.where(Season.gt(Season50).and(Season.lte(Season75)),30); 
Seasonality = Seasonality.where(Season.gt(Season75), 40); 


var Feno = MMax.where(MMax.gt(25).and(MMax.lte(100)), 1); 
Feno = Feno.where(MMax.gt(100).and(MMax.lte(200)),2); 
Feno = Feno.where(MMax.gt(200).and(MMax.lte(300)), 3);
Feno = Feno.where((MMax.gt(300).and(MMax.lte(365))).or(MMax.gt(1).and(MMax.lte(25))), 4); //
...
131, 132, 133, 134, 141,142,143, 144,211, 212, 213,214, 221, 222, 223,224, 
231, 232, 233,234,241,241,243,244, 311, 312, 313,314, 321, 322, 323, 324,
331, 332, 333, 334, 341,342,343,344,411, 412, 413,414, 421, 422, 423, 424,
...
Map.addLayer(TFEclas, vizParamsTFEclasArctic, 'TFE1-64');
    ...
    Export.image.toDrive({
      image: TFEclas,
      description: 'EFT_Landsat7_EVI_2001_2017_NP_4_4',
      region: costa_rica,
      maxPixels: 1e13,
      folder: GDriveOutputImgFolder,
      scale: scale
