...
outname = r'C:\EFT\MODIS_mean_2001_2017_3classes.tif'
...
outname = r'C:\EFT\MODIS_mean_2001_2017_4classes.tif'
gdal_array.SaveArray(output, outname, "gtiff", prototype=dataset)
...
outname = r'C:\EFT\MODIS_mean_2001_2017_5classes.tif'
gdal_array.SaveArray(output, outname, "gtiff", prototype=dataset)
...
outname = r'C:\EFT\MODIS_mean_2001_2017_6classes.tif'
gdal_array.SaveArray(output, outname, "gtiff", prototype=dataset)
...
im = pre_lidar_chm_class_ma.plot.imshow(cmap=cmap,norm=norm)
plt.title('MODIS_mean_6classes')
plt.axis('off')

#plt.show()
plt.savefig("MODIS_mean_spatial_patterns_different_classes.png")
