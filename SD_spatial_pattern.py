...
lidar_dem_path = r'C:\EFT\MODIS_SD_2001_2017.tif'
print(lidar_dem_path)
pre_lidar_chm1 = rxr.open_rasterio(lidar_dem_path, masked=True)
print(type(pre_lidar_chm1))
lidar_dem_im = pre_lidar_chm1
pre_lidar_chm1 = np.where(lidar_dem_im <= 0, np.nan, lidar_dem_im)
print(type(pre_lidar_chm1))
...
class_bins = list(range(1,2000,250))
print(class_bins)
...
# pre_lidar_chm_class_ma = pre_lidar_chm_class.where(pre_lidar_chm_class != 8)
...
# print(lidar_dem_path)
# pre_lidar_chm1 = rxr.open_rasterio(lidar_dem_path, masked=True)*10000
# print(type(pre_lidar_chm1))
# print(pre_lidar_chm1.shape)
# #print(pre_lidar_chm1.squeeze(pre_lidar_chm1, axis=0).shape)
# #https://numpy.org/doc/stable/reference/generated/numpy.squeeze.html
...
# lidar_dem_path = r'C:\EFT\Landsat7_SD_2001_2017_NP.tif'
# print(lidar_dem_path)
# pre_lidar_chm1 = rxr.open_rasterio(lidar_dem_path, masked=True)*10000
# print(type(pre_lidar_chm1))
# print(pre_lidar_chm1.shape)
...
# plt.show()
# plt.savefig("SD_spatial_pattern.png")
