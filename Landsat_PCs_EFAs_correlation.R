...
#PC1 linear varaible
str_name = "C:\\Costa_Rica\\EFT\\PCs\\Landsat7\\Landsat7_2001_2017_PC1.tif"
...
#PC2 linear varaible
str_name = "C:\\Costa_Rica\\EFT\\PCs\\Landsat7\\Landsat7_2001_2017_PC2.tif"
imported_raster=raster(str_name)
print(imported_raster)
...
#PC3 linear varaible
str_name = "C:\\Costa_Rica\\EFT\\PCs\\Landsat7\\Landsat7_2001_2017_PC3.tif"
imported_raster=raster(str_name)
print(imported_raster)
...
write.csv(result,"C:\\Costa_Rica\\EFT\\EFAs\\Landsat7\\Landsat7_PCs_EFAs_correlations.csv")
