...
lidar_dem_path = r"C:\EFT\EFD\EFD_MODIS_EVI_2001_2017_2_2_window_size_7.tif"
...
im = pre_lidar_chm_class_ma.plot.imshow(vmin=1, vmax=8)
#im = pre_lidar_chm.plot.imshow()
#plt.colorbar(im,ticks=class_bins)
plt.title('EFD_MODIS_b2_w7')
plt.axis('off')


lidar_dem_path = r"C:\EFT\EFD\EFD_Landsat7_EVI_2001_2017_2_2_window_size_7.tif"
print(lidar_dem_path)
pre_lidar_chm1 = rxr.open_rasterio(lidar_dem_path, masked=True)
print(type(pre_lidar_chm1))
print(pre_lidar_chm1.shape)
...
pre_lidar_chm_class_ma.plot.imshow(vmin=1, vmax=8)
plt.title('EFD_Landsat_b2_w7')
plt.axis('off')

lidar_dem_path = r"C:\EFT\EFD\clip\EFD_Landsat7_EVI_2001_2017_2_2_window_size_7_clp.tif"
print(lidar_dem_path)
pre_lidar_chm1 = rxr.open_rasterio(lidar_dem_path, masked=True)
print(type(pre_lidar_chm1))
print(pre_lidar_chm1.shape)
...
pre_lidar_chm_class_ma.plot.imshow(vmin=1, vmax=8)
plt.title('EFD_Landsat_b2_w7_NP_clip')
plt.axis('off')


lidar_dem_path = r"C:\EFT\EFD\EFD_Landsat7_EVI_2001_2017_NP_2_2_window_size_7.tif"
print(lidar_dem_path)
pre_lidar_chm1 = rxr.open_rasterio(lidar_dem_path, masked=True)
print(type(pre_lidar_chm1))
print(pre_lidar_chm1.shape)
...
pre_lidar_chm_class_ma.plot.imshow(vmin=1, vmax=8)
plt.title('EFD_Landsat_b2_w7_NP_local')
plt.axis('off')


#plt.show()
plt.savefig("C:\EFT\Fig\EFD_b2_w7.png")
