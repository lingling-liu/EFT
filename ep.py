...
[docs]def colorbar(mapobj, size="3%", pad=0.09):
...
[docs]def make_col_list(unique_vals, nclasses=None, cmap=None):
    """
...
[docs]def draw_legend(im_ax, bbox=(1.05, 1), titles=None, cmap=None, classes=None):
