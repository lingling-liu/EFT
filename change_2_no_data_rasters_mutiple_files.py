...
#directory = "C:/EFT/EFD/percentiles/EFD_gee/NP/nodata/1km/output"
directory = "C:/EFT/EFD/percentiles/EFD_gee/NP/nodata/90m/output"
...
for filename in os.listdir(directory):
    ...
    if os.path.isfile(f): 
        ...
        src = f
        dest = "C:/EFT/EFD/percentiles/EFD_gee/NP/nodata/90m/output/nodata/"+ filename+"_nodata2_compressed.tif"
        print(dest)
        print(src)
