...
#**************************Linear variable****************************
#b2_w3
str_name = "C:\\EFT\\EFD\\percentiles\\EFD_gee\\output\\EFD_MODIS_CR_b2_win3_reclass.tif" 
#loading data sets
...
# #b2_w5
str_name = "C:\\EFT\\EFD\\percentiles\\EFD_gee\\output\\EFD_MODIS_CR_b2_win5_reclass.tif"
imported_raster=raster(str_name)
print(imported_raster)
...
# #b2_w7
str_name = "C:\\EFT\\EFD\\percentiles\\EFD_gee\\output\\EFD_MODIS_CR_b2_win7_reclass.tif"
imported_raster=raster(str_name)
print(imported_raster)
...
# #b4_w3
str_name = "C:\\EFT\\EFD\\percentiles\\EFD_gee\\output\\EFD_MODIS_CR_b4_win3_reclass.tif"
imported_raster=raster(str_name)
print(imported_raster)
...
# #b4_w5
str_name = "C:\\EFT\\EFD\\percentiles\\EFD_gee\\output\\EFD_MODIS_CR_b4_win5_reclass.tif"
imported_raster=raster(str_name)
print(imported_raster)
...
# #b4_w7
str_name = "C:\\EFT\\EFD\\percentiles\\EFD_gee\\output\\EFD_MODIS_CR_b4_win7_reclass.tif"
imported_raster=raster(str_name)
print(imported_raster)
