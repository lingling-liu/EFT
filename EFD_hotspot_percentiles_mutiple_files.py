...
import numpy
# assign directory
directory = "C:\EFT\EFD\percentiles\EFD_test"
...
for filename in os.listdir(directory):
    ...
    if os.path.isfile(f):
        ...
        class_bins = [da_per.values[0]+0.00001,pre_lidar_chm_class_ma.max().values]; does not include da_per.values[0]+0.00001
        ...
        EFD_classified.rio.to_raster("C:/EFT/EFD/percentiles/EFD_test/output/EFD_classified_test.tif",dtype=np.int32)
