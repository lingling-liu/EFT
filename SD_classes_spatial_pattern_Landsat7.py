...
outname = r'C:\EFT\Landsat7_SD_2001_2017_3classes.tif'
...
plt.title('Landsat7_SD_3classes')
plt.axis('off')
...
outname = r'C:\EFT\Landsat7_SD_2001_2017_5classes.tif'
gdal_array.SaveArray(output, outname, "gtiff", prototype=dataset)
...
im = pre_lidar_chm_class_ma.plot.imshow(cmap=cmap,norm=norm)
plt.title('Landsat7_SD_5classes')
plt.axis('off')


#plt.show()
plt.savefig("Landsat7_SD_spatial_patterns_different_classes.png")
