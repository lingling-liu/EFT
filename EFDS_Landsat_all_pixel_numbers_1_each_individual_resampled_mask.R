...
#**************************Linear variable****************************
#b2_w3
str_name = "C:\\EFT\\EFD\\percentiles\\EFD_gee\\nodata\\1km\\output\\nodata\\EFD_Landsat_CR_b2_win3_nodata0_1km_reclass_nodata2_compressed.tif" 
#loading data sets
...
# #b2_w5
str_name = "C:\\EFT\\EFD\\percentiles\\EFD_gee\\nodata\\1km\\output\\nodata\\EFD_Landsat_CR_b2_win5_nodata0_1km_reclass_nodata2_compressed.tif"
imported_raster=raster(str_name)
#print(imported_raster)
...
# #b2_w7
str_name = "C:\\EFT\\EFD\\percentiles\\EFD_gee\\nodata\\1km\\output\\nodata\\EFD_Landsat_CR_b2_win7_nodata0_1km_reclass_nodata2_compressed.tif"
imported_raster=raster(str_name)
#print(imported_raster)
...
# #b4_w3
str_name = "C:\\EFT\\EFD\\percentiles\\EFD_gee\\nodata\\1km\\output\\nodata\\EFD_Landsat_CR_b4_win3_nodata0_1km_reclass_nodata2_compressed.tif"
imported_raster=raster(str_name)
#print(imported_raster)
...
# #b4_w5
str_name = "C:\\EFT\\EFD\\percentiles\\EFD_gee\\nodata\\1km\\output\\nodata\\EFD_Landsat_CR_b4_win5_nodata0_1km_reclass_nodata2_compressed.tif"
imported_raster=raster(str_name)
#print(imported_raster)
...
# #b4_w7
str_name = "C:\\EFT\\EFD\\percentiles\\EFD_gee\\nodata\\1km\\output\\nodata\\EFD_Landsat_CR_b4_win7_nodata0_1km_reclass_nodata2_compressed.tif"
imported_raster=raster(str_name)
#print(imported_raster)
...
# agreement
# str_name = "C:\\EFT\\EFD\\percentiles\\EFD_gee\\efd_Landsat_agreement_1.tif"
# imported_raster=raster(str_name)
# #print(imported_raster)
# Greening_VI11 <- as.data.frame(imported_raster, xy = FALSE)
