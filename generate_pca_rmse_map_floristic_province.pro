pro generate_PCA_rmse_map_floristic_province

  ; read ecoregion data
  infile = '/largedisk_a/Costa_Rica/EFT/zones/floristic_provience.tif'
  ...
  data = data[*,*,2:nl-2]; floristic province
  min1= min(data)
  max1 = max(data)
  ...
  print,'Floristic_Province',mean(result1[index])
