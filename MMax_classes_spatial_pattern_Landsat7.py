...
outname = r'C:\EFT\Landsat7_MMax_2001_2017_2classes.tif'
...
plt.title('Landsat7_MMax_2classes')
plt.axis('off')
...
outname = r'C:\EFT\Landsat7_MMax_2001_2017_3classes.tif'
gdal_array.SaveArray(output, outname, "gtiff", prototype=dataset)
...
im = pre_lidar_chm_class_ma.plot.imshow(cmap=cmap,norm=norm)
plt.title('Landsat7_MMax_3classes')
plt.axis('off')
...
outname = r'C:\EFT\Landsat7_MMax_2001_2017_4classes.tif'
gdal_array.SaveArray(output, outname, "gtiff", prototype=dataset)
...
im = pre_lidar_chm_class_ma.plot.imshow(cmap=cmap,norm=norm)
plt.title('Landsat7_MMax_4classes')
plt.axis('off')


#plt.show()
plt.savefig("Landsat7_MMax_spatial_patterns_different_classes.png")
