...
var GDriveOutputImgFolder = 'GEEOutputs/Landsat7_NP_EFT';
...
//export PCs//
 Export.image.toDrive({
      ...
      description: 'pcImage_Landsat7_EVI'+year_period,
      region: region,
      maxPixels: 1e13,
...
Export.image.toAsset({
      ...
      description: 'Landsat7_NP_PC1'+year_period,
      assetId: 'Landsat7_NP_PC1'+year_period,
      scale: scale,
      region: costa_rica,
      maxPixels: 1e13,
    }) ;
...
Export.image.toDrive({
      image: pcImage.select('pc1').clip(region),
      description: 'Landsat7_2001_2017_PC1_NP',
      region: costa_rica,
      maxPixels: 1e13,
      folder: GDriveOutputImgFolder,
      scale: scale
...
Export.image.toAsset({
      ...
      description: 'Landsat7_NP_PC2'+year_period,
      assetId: 'Landsat7_NP_PC2'+year_period,
      scale: scale,
      region: costa_rica,
      maxPixels: 1e13,
    }) ;
Export.image.toDrive({
      image: pcImage.select('pc2').clip(region),
      description: 'Landsat7_2001_2017_PC2_NP',
      region: costa_rica,
      maxPixels: 1e13,
      folder: GDriveOutputImgFolder,
      scale: scale
...
Export.image.toAsset({
      ...
      description: 'Landsat7_NP_PC3'+year_period,
      assetId: 'Landsat7_NP_PC3'+year_period,
      scale: scale,
      region: costa_rica,
      maxPixels: 1e13,
    }) ;
...
Export.image.toDrive({
      image: pcImage.select('pc3').clip(region),
      description: 'Landsat7_2001_2017_PC3_NP',
      region: costa_rica,
      maxPixels: 1e13,
      folder: GDriveOutputImgFolder,
      scale: scale
