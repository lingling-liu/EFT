...
lidar_dem_path = r"C:\EFT\EFT_4_4_4_2_2_2\EFT_MODIS_EVI_2001_2017_2_2.tif"
...
plt.title('EFT_MODIS_b2')
plt.axis('off')


lidar_dem_path = r"C:\EFT\EFT_4_4_4_2_2_2\EFT_Landsat7_EVI_2001_2017_2_2.tif"
print(lidar_dem_path)
pre_lidar_chm1 = rxr.open_rasterio(lidar_dem_path, masked=True)
print(type(pre_lidar_chm1))
print(pre_lidar_chm1.shape)
...
plt.title('EFT_Landsat_b2')
plt.axis('off')

lidar_dem_path = r"C:\EFT\EFT_4_4_4_2_2_2\Landsat\clip\EFT_Landsat7_EVI_2001_2017_2_2_clip.tif"
print(lidar_dem_path)
pre_lidar_chm1 = rxr.open_rasterio(lidar_dem_path, masked=True)
print(type(pre_lidar_chm1))
print(pre_lidar_chm1.shape)
...
pre_lidar_chm_class_ma.plot.imshow(vmin=1, vmax=8)
plt.title('EFT_Landsat_b2_NP_clip')
plt.axis('off')


lidar_dem_path = r"C:\EFT\EFT_4_4_4_2_2_2\EFT_Landsat7_EVI_2001_2017_NP_2_2.tif"
print(lidar_dem_path)
pre_lidar_chm1 = rxr.open_rasterio(lidar_dem_path, masked=True)
print(type(pre_lidar_chm1))
print(pre_lidar_chm1.shape)
...
pre_lidar_chm_class_ma.plot.imshow(vmin=1, vmax=8)
plt.title('EFT_Landsat_b2_NP_local')
plt.axis('off')


#plt.show()
plt.savefig("C:\EFT\Fig\EFT_b2.png")
