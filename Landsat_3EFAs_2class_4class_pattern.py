...
im = pre_lidar_chm_class_ma.plot.imshow(vmin=0.2, vmax=0.7,cmap=my_cmap)
...
# Mean 2 classes********************************************
lidar_dem_path = "C:\EFT\EFAs\CR\classes_22_44\Landsat7_mean_2001_2017_2classes.tif"
print(lidar_dem_path)
pre_lidar_chm1 = rxr.open_rasterio(lidar_dem_path, masked=True)
print(type(pre_lidar_chm1))
print(pre_lidar_chm1.shape)
...
plt.title('Mean_2classes_Landsat7')
plt.axis('off')

#SD two classes
lidar_dem_path = "C:\EFT\EFAs\CR\classes_22_44\Landsat7_SD_2001_2017_2classes.tif"
print(lidar_dem_path)
pre_lidar_chm1 = rxr.open_rasterio(lidar_dem_path, masked=True)
print(type(pre_lidar_chm1))
print(pre_lidar_chm1.shape)
...
im = pre_lidar_chm_class_ma.plot.imshow(cmap=cmap,norm=norm)
plt.title('SD_2classes_Landsat7')
plt.axis('off')

#DMax two classes
lidar_dem_path = "C:\EFT\EFAs\CR\classes_22_44\Landsat7_MMax_2001_2017_2classes.tif"
print(lidar_dem_path)
pre_lidar_chm1 = rxr.open_rasterio(lidar_dem_path, masked=True)
print(type(pre_lidar_chm1))
print(pre_lidar_chm1.shape)
...
im = pre_lidar_chm_class_ma.plot.imshow(cmap=cmap,norm=norm)
plt.title('DMax_2classes_Landsat7')
plt.axis('off')

#Mean 4 classes*******************************************
lidar_dem_path = "C:\EFT\EFAs\CR\classes_22_44\Landsat7_mean_2001_2017_4classes.tif"
print(lidar_dem_path)
pre_lidar_chm1 = rxr.open_rasterio(lidar_dem_path, masked=True)
print(type(pre_lidar_chm1))
print(pre_lidar_chm1.shape)
...
im = pre_lidar_chm_class_ma.plot.imshow(cmap=cmap,norm=norm)
plt.title('Mean_Landsat7_4classes')
plt.axis('off')

#SD 4 classses
lidar_dem_path = "C:\EFT\EFAs\CR\classes_22_44\Landsat7_SD_2001_2017_4classes.tif"
print(lidar_dem_path)
pre_lidar_chm1 = rxr.open_rasterio(lidar_dem_path, masked=True)
print(type(pre_lidar_chm1))
print(pre_lidar_chm1.shape)
...
im = pre_lidar_chm_class_ma.plot.imshow(cmap=cmap,norm=norm)
plt.title('SD_Landsat7_4classes')
plt.axis('off')

#Dmax 4 classes
lidar_dem_path = "C:\EFT\EFAs\CR\classes_22_44\Landsat7_MMax_2001_2017_4classes.tif"
print(lidar_dem_path)
pre_lidar_chm1 = rxr.open_rasterio(lidar_dem_path, masked=True)
print(type(pre_lidar_chm1))
print(pre_lidar_chm1.shape)
...
im = pre_lidar_chm_class_ma.plot.imshow(cmap=cmap,norm=norm)
plt.title('DMax_4classes_Landsat7')
plt.axis('off')

#plt.show()
plt.savefig("C:\EFT\Fig\EFAs_Landsat.png")